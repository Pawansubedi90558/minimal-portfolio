...
function Intro(){
    return (
        <div id="intro" className="flex items-center justify-center p-4 h-screen">
            <div className="w-6/12 flex items-center justify-center flex-col text-center pt-20 pb-6">
                <h1 className="text-4xl md:text-7xl dark:text-white mb-1 md:mb-3 font-bold"><span className="text-blue-600">Pawan</span> Subedi</h1>
